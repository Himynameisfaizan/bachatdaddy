                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                            <div class="footer-widget-three__column footer-widget-three__about">
                                <div class="footer-widget-two__logo">
                                    <a href="index.php"><img src="images/resources/Asset 19-8.png"
                                            alt="logoImg" style="width: 100%; height: 100%; object-fit: contain;"></a>
                                </div>
                        ...
                        <div class="col-xl-2 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                            <div class="footer-widget-three__column footer-widget-three__company">
                                ...
                                <ul class="footer-widget-three__company-list list-unstyled">
                                    ...
                                    <li>
                                        <svg fill="white" height="13px" width="13px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 492.004 492.004" xml:space="preserve"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <g> <path d="M382.678,226.804L163.73,7.86C158.666,2.792,151.906,0,144.698,0s-13.968,2.792-19.032,7.86l-16.124,16.12 c-10.492,10.504-10.492,27.576,0,38.064L293.398,245.9l-184.06,184.06c-5.064,5.068-7.86,11.824-7.86,19.028 c0,7.212,2.796,13.968,7.86,19.04l16.124,16.116c5.068,5.068,11.824,7.86,19.032,7.86s13.968-2.792,19.032-7.86L382.678,265 c5.076-5.084,7.864-11.872,7.848-19.088C390.542,238.668,387.754,231.884,382.678,226.804z"></path> </g> </g> </g></svg>
                                        <a href="terms-and-conditions-policy.php">Terms and Conditions Policy</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <ul class="px-0">
                                    ...
                                    <li class="mb-20">
                                        <div class="site-footer-three__contact-list-single">
                                            ...
                                            <div class="content">
                                                <h3>Email</h3>
                                                <p><a href="mailto:support@bachatdaddy.com">daddybachat@gmail.com</a></p>
                ...
                <div class="container">
                    <div class="site-footer-three__bottom-inner">
                        ...
                        <div class="site-footer-three__bottom-text">
                            <div class="">CIN: U73100UP2025OPC230593 | TAN: ALDE01280G*</div>
                        </div>
                    </div>
                </div>
            </div>
