...
<head>
    ...
    <link
        href="../../css2-1?family=Inter+Tight:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap"
        rel="stylesheet">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Representative's Name" name="representative_name" id="representative_name">
                                        </div>
                                    </div>
    ...
    $(document).ready(function () {
        function submitForm(event, formName) {
            ...
            if ($(form).valid()) {
                ...
                submitButton.disabled = false;
                submitButton.innerHTML = 'Submit'; // Re-enable the submit button if validation fails
            }
        }
        ...
        $("#profileForm").validate({
            rules: {
                ...
                phone: {
                    required: true,
                    phoneUS: true // or use a custom regex for international phones
                },
                birthday: {
                    required: true,
                    date: true
            ...
            messages: {
                ...
                phone: {
                    ...
                    phoneUS: "Please enter a valid phone number" // Modify according to phone format
                },
                birthday: {
                ...
                anniversary: {
                    required: "Please select your anniversary date",
                    date: "Please enter a valid date"
                },
                state: {
            ...
            // The form will be validated before submitting
            submitHandler: function (form) {
                submitForm(event, 'profileForm'); // Trigger the custom submit function
            }
        });
    });
</script>
