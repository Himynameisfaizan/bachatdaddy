        ...
        ***********************************-->
        <div class="nav-header">
        	<a href="home.php" class="navbar-brand d-flex align-items-center ">
        		...
        		<img id="logoImg" class="img-logo img-fluid logo-1" src="images/logo/Asset 19-8.png" alt="Logo">
        	</a>
        	<a href="home.php" class="navbar-brand d-flex align-items-center ">
        		<!-- Image that will be changed -->
        		<img id="logoImg" class="img-logo img-fluid logo-2" src="images/logo/logo1.png" alt="Logo">
        	</a>
        							...
        							<div class="dropdown-menu dropdown-menu-end pb-0" style="">
        								<div class="card mb-0">
        									...
        									<div class="card-footer text-center p-3">
        										<a href="signout.php" class="dropdown-item ai-icon btn btn-primary light">
