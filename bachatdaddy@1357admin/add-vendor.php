<?php 
    ...
    if (isset($_POST['submit']) && $_POST['submit'] == 'Submit') {
        ...
        $result = $vendor->addVendor($name,$subindustry,$address,$city,$email,$offer,$password,$image,$sdate,$edate);
        if ($result == true) {
            ...
            if (!empty($_POST['offers'])) {
                foreach ($_POST['offers'] as $offer) {
                    ...
                    $result = $vendor->insertVendorOffer($vandor_id, $offer);
                        ...
                        <div class="card-header flex-wrap d-flex justify-content-between border-0 px-3">
                            ...
                            <form id="vendorForm" method="post" enctype="multipart/form-data" class="form-horizontal ms-5"  >
                                        ...
                                        <div class="phone_field_wrapper mb-4">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-3">
                                                    <input type="tel" name="phones[]" class="form-control" required title="Please Provide a phone number" maxlength="15" placeholder="Phone">
                                                </div>
                                                <div class="col-md-2">
                                        ...
                                        <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-3">
                                                    <input type="email" name="emails[]" class="form-control" required title="Please provide an Email" maxlength="200" placeholder="Additional Email">
                                                </div>
                                                <div class="col-md-2">
                                        ...
                                        <div class="row form-group mb-4">
                                            ...
                                            <div class="field_wrapper mb-4 ">
                                                <div class="row form-group">
                                                    <div class="col col-md-2">
                                                        <label class="form-control-label">Add More Images (Size : 1200px*1125px) Please add minimum 2 images</label>
                                                    </div>
                                                    <div class="col-12 col-md-6">
                                                        <input type="file" onchange="return fileValidation1(this)"  name="images[]"  required  class="form-control w-80">
                                                    </div>
                                                    <div class="col-md-2">
                                            ...
                                            <div class="row form-group mb-4">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <input type="text" id="offerhead" placeholder="Enter Offer Heading" name="offerhead" class="form-control" maxlength="200">
                                                </div>
                                            </div>
                                            <div class="row form-group mb-4">
                                                <div class="col col-md-2">
                                            ...
                                            <div class="sconditions_field_wrapper mb-4">
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-3">
                                                        <input type="text" name="sconditions[]" class="form-control" required title="Please provide the Special terms and condition description" maxlength="200" placeholder="Special conditions Description">
                                                    </div>
                                                    <div class="col-md-2">
                                            ...
                                            <div class="gconditions_field_wrapper mb-4">
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-3">
                                                        <input type="text" name="gconditions[]" class="form-control" required title="Please provide the general terms and condition description" maxlength="200" placeholder="General conditions Description">
                                                    </div>
                                                    <div class="col-md-2">
