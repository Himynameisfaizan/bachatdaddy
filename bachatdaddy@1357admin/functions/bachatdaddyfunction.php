...
class Vendor
{
    ...
    public function addVendor($name, $subindustry, $address, $city, $email, $password, $image, $couponcount, $discountdiscription, $mobile)
    {
        $conn = new dbClass;
        $this->conndb = $conn;
        $sql = "INSERT INTO `vendor` (name,category_id, address, city_id, email, password, image, coupon_count, discount_description, mobile) VALUES (:name, :subindustry, :address, :city, :email, :password, :image, :couponcount, :discountdiscription, :mobile)";
    ...
    public function insertVendorOffer($vendorId, $offer, $sdate, $edate)
    {
        $conn = new dbClass();
        $this->conndb = $conn;
        $sql = "INSERT INTO `venderoffer` (`vendor_id`, `offer`, `sdate`, `edate`) VALUES (:vendorId, :offer, :sdate, :edate)";
    ...
    function VlastOfferId()
    {
        $conn = new dbClass;
        $stmt = $conn->getData("SELECT * FROM `venderoffer` ORDER BY `id` DESC");
        return $stmt;
    }
    public function insertProductImages($vendorId, $resizedImage, $offer_id)
    {
        $conn = new dbClass();
        $this->conndb = $conn;
        $sql = "INSERT INTO `vendor_images` (`vendor_id`, `image`, `offer_id`) VALUES (:vendorId, :image, :offer_id)";
    ...
    public function insertVendorEmail($productId, $email, $offer_id)
    {
        $conn = new dbClass();
        $this->conndb = $conn;
        $sql = "INSERT INTO `venderemail` (`vendor_id`, `email`, `offer_id`) VALUES (:productId, :email, :offer_id)";
    ...
    public function insertVendorPhone($productId, $phone, $offer_id)
    {
        $conn = new dbClass();
        $this->conndb = $conn;
        $sql = "INSERT INTO `vendermobile` (`vendor_id`, `mobile`, `offer_id`) VALUES (:productId, :phone, :offer_id)";
    ...
    public function insertVendorScondition($vendorId, $scondition, $offer_id)
    {
        $conn = new dbClass();
        $this->conndb = $conn;
        $sql = "INSERT INTO `venderscondition` (`vendor_id`, `condition`, `offer_id`) VALUES (:vendorId, :scondition,:offer_id)";
    ...
    public function insertVendorGcondition($vendorId, $gcondition, $offer_id)
    {
        $conn = new dbClass();
        $this->conndb = $conn;
        $sql = "INSERT INTO `vendergcondition` (`vendor_id`, `condition`, `offer_id`) VALUES (:vendorId, :gcondition, :offer_id)";
