        ...
        <section class="portfolio-three pt-75 ">
            ...
            <div class="container">
                <div class="section-title-three text-center">
                    ...
                    <h2 class="section-title-three__title">Jewellery</h2>
                </div>
                
                <div class="row filter-layout">
                    <div class="col-xl-4 col-lg-6 col-md-6 filter-item tax  ">
                        <div class="portfolio-three__single">
                            ...
                            <div class="portfolio-three__content">
                                <h3 class="portfolio-three__title"><a href="#0">Jewellery</a>
                                </h3>
                            </div>
                        </div>
                    </div>
