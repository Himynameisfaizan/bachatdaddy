...
<!--**********************************
        ...
        <section class="portfolio-three pt-75 ">
            ...
            <div class="container">
                <div class="section-title-three text-center">
                    ...
                    <h2 class="section-title-three__title">College</h2>
                </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 filter-item financial ">
                        <div class="portfolio-three__single">
                            ...
                            <div class="portfolio-three__content">
                                <h3 class="portfolio-three__title"><a href="#0">College</a></h3>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="mobile-nav__wrapper">
        ...
        <div class="mobile-nav__content">
            ...
            <div class="logo-box">
                <a href="index.php" aria-label="logo image"><img src="images/resources/logo-1.png" width="250"
                        alt=""></a>
            </div>
            <!-- /.logo-box -->
